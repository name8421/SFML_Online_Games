...
void SettingsState::initGui()
{
	...
	this->dropDownLists["RESOLUTION"] = new gui::DropDownList(
		gui::p2pX(42.f, vm), gui::p2pY(12.f, vm),
...
SettingsState::SettingsState(StateData* state_data, MenuState* menu_state)
	: State(state_data), menu_state(menu_state)
{
	this->initVariables();
	this->initFonts();
	//this->initKeybinds();
